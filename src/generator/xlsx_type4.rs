...
mod tests {
    ...
    fn test_output_worksheet_basic_and_no_merge() -> Result<()> {
        ...
        let gen2 = XlsxType4Generator::new(
            ...
            XlsxType4GeneratorOptions {
                integrate_cells: None,
                shironuri: false, // Added this line
            },
        );
    ...
    #[test]
    fn test_xlsx_type4_generator_shironuri_enabled() -> Result<()> {
        let outline = Outline {
        ...
        let options = XlsxType4GeneratorOptions {
            integrate_cells: None,
            shironuri: true,
        };
    ...
    #[test]
    fn test_xlsx_type4_generator_shironuri_disabled() -> Result<()> {
        let outline = Outline {
            key_header: vec!["Key".to_string()],
            value_header: vec!["Value1".to_string(), "Value2".to_string()],
            item: vec![OutlineItem::new(
